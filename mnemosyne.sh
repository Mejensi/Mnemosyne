#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════════════
#                   MNEMOSYNE V1.2 - Mac/Linux Launcher
#
...
# Multi-line string embedding for the Python core
python3 - << 'PY_EOF' "$@"
# -*- coding: utf-8 -*-
"""
Mnemosyne V1.2 - The Keeper of Digital Memory
Copyright (C) 2026 Mejensi
...
VERSION, APP_NAME = "1.2", "Mnemosyne"
